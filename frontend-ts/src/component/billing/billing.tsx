    ...
    return (
        <div className="bg-slate-50 py-4 dark:bg-slate-900">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <h2
                    className="mt-2 text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-200 sm:text-5xl"
                >
                    Pricing plans
                </h2>
                <div className="mt-16 flex justify-center">
                    <div
                    className="rounded-full border border-slate-300 p-1 dark:border-slate-300/20"
                    >
                    <div className="flex text-xs font-semibold leading-5">
                        <button
                        className="w-auto rounded-full bg-blue-600 px-3 py-1 text-slate-200 focus:outline-none"
                        >
                        Monthly
                        </button>
                        <button
                        className="rounded-full px-3 py-1 text-slate-800 focus:outline-none dark:text-slate-200"
                        >
                        Yearly
                        </button>
                    </div>
                ...
                <div
                className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-4"
                >
                <div
                ...
                >
                    ...
                    <div className="flex items-center justify-between gap-x-4">
                        <h3 id="tier-starter" className="text-lg font-semibold leading-8">
                        Starter
                        </h3>
                        <p
                    ...
                    <p className="mt-6 flex items-baseline gap-x-1">
                        ...
                        <span
                        className="text-sm font-semibold leading-6 text-slate-700 dark:text-slate-400"
                        >/month</span
                        >
                    </p>
                    <ul
                ...
                <div
                    className="flex flex-col justify-between rounded-3xl bg-slate-50 p-8 text-slate-900 ring-1 ring-slate-300 dark:bg-slate-900 dark:text-slate-200 dark:ring-slate-300/20 lg:z-10 xl:p-10"
                >
                    <div>
                    <div className="flex items-center justify-between gap-x-4">
                        <h3 id="tier-startup" className="text-lg font-semibold leading-8">
                        Pro
                        </h3>
                        <p
                        className="rounded-full bg-blue-600/10 px-2.5 py-1 text-xs font-semibold leading-5 text-blue-600"
